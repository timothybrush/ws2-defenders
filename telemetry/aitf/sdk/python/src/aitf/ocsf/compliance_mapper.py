...
FRAMEWORK_MAPPINGS: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "csa_aicm": {
        ...
        "supply_chain": {
            ...
            "domains": ["STA", "CCC", "MDS", "DCS", "IPY", "I&S"],
        },
        "governance": {
            "controls": [
            ...
            "domains": ["GRC", "A&A", "BCR", "HRS", "LOG", "DSP"],
        },
        "identity": {
            "controls": [
