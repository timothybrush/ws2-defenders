...
> **Status caveat.** NIST AI RMF 1.0 (January 2023) is **under revision**. The **Cyber AI Profile** is at *preliminary draft* (**NIST IR 8596**, published 16 December 2025); the comment period closed 30 January 2026 and an Initial Public Draft was not published at the time of writing. Structure and identifiers below were read at the time of writing and must be re-verified before publication.
...
> **Access caveat.** ISO/IEC 42001 is a paid standard and was not read in full. Control-objective titles and control identifiers below are **given as encountered in public summaries**, not verified against the purchased text; **verify every identifier and title before treating this mapping as normative**. Control numbering within each objective (e.g. `A.6.2.8`) is especially error-prone in secondary sources.
